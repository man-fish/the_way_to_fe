...
![2014012719413820164](\assets\2014012719413820164.jpg)
...
<img src="\assets\th-1577029663225.jpg" alt="See the source image" style="zoom:50%;" />

### 思路分析

n皇后的解空间很好分析，就是N个循环次数为N的for循环，如果不加上剪枝函数的话那么需要进行搜索的次数就是n的n次幂，不过如下图我们使用了剪枝函数之后搜索的次数就会大大降低，而且我们要知道for循环之间创造的递归都是独立的。

<img src="\assets\111164.jpg" alt="111164" style="zoom:90%;" />
...
<img src="\assets\TIM图片20191223000402-1577030716643.png" alt="TIM图片20191223000402" style="zoom:80%;" />
