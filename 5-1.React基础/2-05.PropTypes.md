...
`React v15.5` 起，`React.PropTypes` 已移入另一个包中。我们使用 [`prop-types 库`](https://www.npmjs.com/package/prop-types) 代替。
...
你可以通过 `PropTypes.element.isRequired` 来确保传递给组件的 children 中只包含一个元素。
