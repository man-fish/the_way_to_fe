...
> http请求发送之前，一个请求报文可能包含实体和报文，实体会打包成chunk块，然后服务端读取的时候服务端先看报文（也就是请求报文），然后一块一块的下载chunk块，最后拼接成真正实体，读取数据。
...
{ 'accept-ranges': 'bytes',
  ...
  date: 'Mon, 18 Nov 2019 04:26:08 GMT',
  p3p:
   'CP=" OTI DSP COR IVA OUR IND COM ", CP=" OTI DSP COR IVA OUR IND COM "',
  pragma: 'no-cache',
  server: 'BWS/1.1',
  'set-cookie':
   [ 'BAIDUID=4F89BA9E295B21F3E4B5F795844859D4:FG=1; expires=Thu, 31-Dec-37 23:55:55 GMT; max-age=2147483647; path=/; domain=.baidu.com',
     'BIDUPSID=4F89BA9E295B21F3E4B5F795844859D4; expires=Thu, 31-Dec-37 23:55:55 GMT; max-age=2147483647; path=/; domain=.baidu.com',
     'PSTM=1574051168; expires=Thu, 31-Dec-37 23:55:55 GMT; max-age=2147483647; path=/; domain=.baidu.com',
     'BAIDUID=4F89BA9E295B21F3A76E926E5CE98613:FG=1; max-age=31536000; expires=Tue, 17-Nov-20 04:26:08 GMT; domain=.baidu.com; path=/; version=1; comment=bd' ],
  traceid: '157405116805128258662793825056974117913',
  vary: 'Accept-Encoding',
  'x-ua-compatible': 'IE=Edge,chrome=1',
  connection: 'close' }
```

##### 然后一步一步的拿到chunk（二进制编码块）

```http
<Buffer 3c 21 44 4f 43 54 59 50 45 20 68 74 6d 6c 3e 3c 21 2d 2d 53 54 41 54 55 53 20 4f 4b 2d 2d 3e 0d 0a 3c 68 74 6d 6c 3e 0d 0a 3c 68 65 61 64 3e 0d 0a 09 ... >
```
